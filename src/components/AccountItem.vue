...
watch(() => props.account.tags, (newTags) => {
  tagsString.value = accountStore.getTagsAsString(newTags) 
})

watch(() => props.account.login, (newLogin) => {
  localLogin.value = newLogin
})

watch(() => props.account.password, (newPassword) => {
